...
def main(tracking_uri, experiment_name, project_uri, version):
    ...
    run = mlflow.projects.run(uri=project_uri, env_manager="virtualenv", version=version, experiment_id=experiment_id)
